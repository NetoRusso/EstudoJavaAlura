/*Escreva um programa que converta uma temperatura em graus Celsius para Fahrenheit. Utilize variáveis para representar ovalores das temperaturas e imprima no console o valor convertido de Celsius para Fahrenheit.
